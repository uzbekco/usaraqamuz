...
$bot = "@Gold_Oddiy_USA_Bot"; //bot ismi
...
Referal orqali botga 15 bal toʻplasangiz 2 ta usa nomer olishingiz mumkin.
Kanal Orqali botka 5 ta Doʻstingizni chaqirib 2 bal olishingiz mumkin.
...
'text'=>"1 kun ichida sizga usa nomerlar yetib boradi!",
        ...
        bot('sendMessage',[
        'chat_id'=>$cid,
        'text'=>"@Shox_Xacker! ga yozing
⛔Spam boʻlsangiz: @Free_Fire_uzbgroup ga yozing!",
        'reply_to_message_id'=>$mid,
        ]);
        $ball -=10;
...
➖➖➖➖➖➖➖➖➖➖➖➖�?
💸Toʻlangan Usalar: 2 ta
♻️Yangilargan Sana: 13.07.2019 yil.",
      'reply_to_message_id'=>$mid,
      'reply_markup'=>$key,
      ]);
    }
    ...
    if($tx == "👨🏻‍💻Admin Bilan Bogʻlanish👨🏻‍�?"){
      ...
      bot('sendMessage',[
      'chat_id'=>$cid,
'text'=>"Admin: @Shox_Xacker
 🕗Ish Vaqti: 4 soat
Bot yaratishni istasangiz: @Shox_Xacker
⛔Spamlar: @Free_Fire_uzbgroup";
      'reply_to_message_id'=>$mid,
      'reply_markup'=>$key,
      ]);
    }
...
$okcha = "Siz kanalga a'zo boʻldingiz va 2 balga ega boʻldingiz!
...
$kabi = $kabin + 5;
    ...
    if(isset($tx)){
      ...
      foreach($faylla as $fayl){
        ...
        bot('sendMessage',[
        'chat_id'=>$usri,
        'text'=>"Siz $chati kanalidan 5 kun boʻlmasidan chiqib ketdingiz.Sizdan 2 bal ayirilmoqda... ",
        'reply_markup'=>$key,
        ]);
        /// @PHP_New kanaliga obuna bo'ling///
